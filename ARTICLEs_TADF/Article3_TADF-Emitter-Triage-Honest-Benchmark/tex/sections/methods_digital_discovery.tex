...
We report \qty{95}{\percent} confidence intervals from \num{2000} bootstrap
resamples of the out-of-fold predictions, and benchmark against a mean-value
predictor and the raw sTDA gap. Feature importance was quantified with exact
TreeSHAP~\cite{Lundberg2017} on the fitted forest. All scripts
(\texttt{code/finalize\_model.py}, \texttt{code/rebuild\_structural\_model.py})
regenerate every reported number and \cref{fig:model_performance}.
