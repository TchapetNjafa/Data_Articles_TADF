...
We have benchmarked, honestly and reproducibly, how well cheap structure-based
machine learning can predict the experimental singlet--triplet gap
$\Delta E_\text{ST}$ of TADF emitters. Three findings stand out.
...
ranking ($\rho \approx 0.3$): modestly above a mean-value baseline. The excited-state
...
Inter-laboratory disagreement (\qtyrange{0.1}{0.15}{\electronvolt}) and the
functional dependence of the computed reference (up to \qty{0.58}{\electronvolt}
between B3LYP and CAM-B3LYP) bound achievable accuracy near
